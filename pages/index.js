        ...
        <div className="max-w-screen-xl mx-auto border-t border-lightBgSecondaryColorTranslucent dark:border-bgSecondaryColor py-7 md:py-10">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(18rem,0.9fr)] lg:gap-16">
            <div>
              ...
              <Link href="/case-studies" prefetch={false}><a className="inline-flex items-center gap-3 mt-7 pb-1 border-b border-pink text-base md:text-lg text-lightTextColor dark:text-white transition hover:text-pink focus-visible:text-pink">View all case studies <ArrowIcon /></a></Link>
            </div>
            <Link href={`/case-studies/${caseStudies[0].slug}`} prefetch={false}>
              <a className="group block border-l-2 border-pink pl-5 sm:pl-7 lg:pl-9 py-1 transition hover:border-lightTextColor dark:hover:border-white">
                ...
                <span className="flex items-end gap-4 mt-8 pt-5 border-t border-lightBgSecondaryColorTranslucent dark:border-bgSecondaryColor">
                  <span className="font-secondary text-3xl sm:text-4xl md:text-5xl leading-none tracking-tight text-pink tabular-nums"><MetricValue value={caseStudies[0].metric} /></span>
                ...
                <span className="inline-flex items-center gap-2 mt-7 text-base text-lightTextColor dark:text-white group-hover:translate-x-1 transition-transform">Read the story <ArrowIcon /></span>
              </a>
            </Link>
          </div>
        </div>
